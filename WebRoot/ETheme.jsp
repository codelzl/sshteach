...
search_value = '';
	...
	<div class="center">	      
          ...
          <div class="alert alert-info">	
           <h2> ${ThemeID.theme}</h2>     >>>>话题发起者：${USERID}
           </div>
		<h3 align="center">已有回复</h3>
  		<div class="alert alert-success">	
  					
  				 <table class="table table-hover" width="100%">
            <s:iterator id="rl" value="#session.ContentID">
           
        <tr>
            <td class="TD_STYLE2 col-lg-4 text-center">
              <h4> 用户回复：</h4>> <s:property value="#rl.content"/>
            </td>
       </tr>
		...
		<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/Ncontent">
		<div class="center">
			<div class="control-group"   width="100%">
					...
					<input type="hidden" name="id" value="${Tid}" />
                     <textarea   name="content" rows="3" style="width: 615px; height: 212px"></textarea>
