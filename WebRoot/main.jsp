...
search_value = '';
	...
	<div id="header">
		...
		<div class="logo_msk"></div>
         ...
         <h2  align="center">请在下方输入要搜索的话题</h2>
         <form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/FindTheme">
        <div class="center">    
        <textarea  name="searchValue" rows="6" style="width: 615px; height: 55px"></textarea>
        <button type="submit"  class="btn btn-large  btn-primary">搜索</button>
        </div>
        ...
        <br><br><br><br>
         ...
         <a href="MyTheme" class="btn btn-large btn-primary">我的主题管理</a>
        </div>
