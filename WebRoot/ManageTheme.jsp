...
search_value = '';
	...
	<div id="container">
     ...
     <table class="table table-hover" width="100%">
            <s:iterator id="rl" value="#session.ThemeInfo">
           
        <tr>
            <td class="TD_STYLE2 col-lg-4 text-center">
                <a href="Etheme?id=<s:property value="#rl.tid"/>" class="btn btn-link"><s:property value="#rl.title"/></a>
           
           <a href="UpFirstTheme?id=<s:property value="#rl.tid"/>" class="btn btn-large btn-primary ">话题更新</a>
            <a href="DTheme?id=<s:property value="#rl.tid"/>" class="btn btn-large btn-primary ">话题删除</a>
