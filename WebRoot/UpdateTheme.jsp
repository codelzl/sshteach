...
search_value = '';
	...
	<div id="container">
		...
		<h2  align="center">请在下方输入要修改的相关话题内容：</h2>
		</div>
		
	
		<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/UpdateTheme">
		<div class="center">
			<div class="control-group"   width="100%">
  					<h3 align="center">主题题目</h3>
  					<input type="hidden" name="id" value="${UpID.tid}" />
					<textarea  name="title" value="title" rows="6" style="width: 615px; height: 88px">${UpID.title}</textarea>
					<h3 align="center">主题内容</h3>
                     <textarea   name="content" value="content"  rows="3" style="width: 615px; height: 257px">${UpID.theme}</textarea>
    				<div class="form-actions" align="center">
  						 <button type="submit" class="btn btn-large  btn-primary">确认更新</button>
